...
--
-- Host: 127.0.0.1
-- Czas generowania: 25 Maj 2021, 16:40
...
INSERT INTO `daneosobowe` (`ID`, `Imię`, `Nazwisko`, `Pesel`, `E-mail`, `NumerTelefonu`, `Lokalizacja_ID`) VALUES
...
--
-- Struktura tabeli dla tabeli `kontoklient`
--

CREATE TABLE `kontoklient` (
  `ID` int(11) NOT NULL,
...
--
-- Zrzut danych tabeli `kontoklient`
--

INSERT INTO `kontoklient` (`ID`, `Login`, `Hasło`) VALUES
...
--
-- Struktura tabeli dla tabeli `kontopracownik`
--

CREATE TABLE `kontopracownik` (
  `ID` int(11) NOT NULL,
...
--
-- Zrzut danych tabeli `kontopracownik`
--

INSERT INTO `kontopracownik` (`ID`, `Login`, `Hasło`) VALUES
...
CREATE TABLE `kredyt` (
  ...
  `Rodzaj Kredytu_ID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `kredyt` (`ID`, `Wartość`, `Klient_ID`, `DataZałożenia_ID`, `DataZakończenia_ID`, `Rodzaj Kredytu_ID`) VALUES
(1, '2000.00', 1, 16, 17, 2),
(2, '5000.00', 2, 18, 19, 3),
(3, '8000.00', 3, 20, 21, 4),
(4, '1000.00', 4, 22, 13, 3),
...
(4, 'Śląskie', 'Katwice', '40-014', '', 'Tysięciolecia', '125'),
(5, 'Śląskie', 'Częstochowa', '42-217', '', 'Wiatrakowa', '10'),
(6, 'Lubuskie', 'Zielona Góra', '30-600', '', 'Polna', '14'),
(7, 'Podkarpackie', 'Rzeszów', '33-634', '', 'Łakowa', '4'),
(8, 'Mazowieckie', 'Ostrołęka', '73-687', '', 'Krótka', '150'),
(9, 'Łodźkie', 'Łódz', '40-619', '', 'Kolejowa', '225'),
(10, 'Pomorskie', 'Gdańsk', '05-090', '', 'Akacjowa', '89'),
...
--
-- Struktura tabeli dla tabeli `rachunekdebetowy`
--
...
--
-- Zrzut danych tabeli `rachunekdebetowy`
--

INSERT INTO `rachunekdebetowy` (`ID`, `Klient_ID`, `PIN`, `Debet`) VALUES
('0000-0000-0001', 1, '1234', '200.00'),
('0000-0000-0002', 2, '4301', '300.00'),
('0000-0000-0003', 2, '5609', '0.00'),
...
--
-- Struktura tabeli dla tabeli `rachunekkredytowy`
--
...
--
-- Zrzut danych tabeli `rachunekkredytowy`
--

INSERT INTO `rachunekkredytowy` (`ID`, `Klient_ID`, `PIN`, `Środki`) VALUES
('0000-0000-0001', 1, '6890', '12000.00'),
('0000-0000-0002', 2, '4040', '3000.00'),
('0000-0000-0003', 4, '1221', '5000.00'),
('0000-0000-0004', 4, '912', '9000.00'),
('0000-0000-0005', 3, '976', '12000.00');

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `rodzajkredytu`
--
...
--
-- Zrzut danych tabeli `rodzajkredytu`
--

INSERT INTO `rodzajkredytu` (`ID`, `Nazwa`, `Oprocentowanie`) VALUES
...
--
-- Struktura tabeli dla tabeli `rodzajlokaty`
--
...
--
-- Zrzut danych tabeli `rodzajlokaty`
--

INSERT INTO `rodzajlokaty` (`ID`, `Nazwa`, `Oprocentowanie`) VALUES
...
--
-- Struktura tabeli dla tabeli `rodzajtransakcji`
--
...
--
-- Zrzut danych tabeli `rodzajtransakcji`
--

INSERT INTO `rodzajtransakcji` (`ID`, `Nazwa`) VALUES
...
CREATE TABLE `stanowisko` (
  `ID` int(11) NOT NULL,
  `Nazwa` varchar(50) NOT NULL,
  `Płaca podstawowa` decimal(7,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `stanowisko` (`ID`, `Nazwa`, `Płaca podstawowa`) VALUES
...
CREATE TABLE `wypłata` (
  `ID` int(11) NOT NULL,
  `Miesiąc` varchar(50) NOT NULL,
  `Pensja Całkowita` decimal(7,2) NOT NULL,
...
INSERT INTO `wypłata` (`ID`, `Miesiąc`, `Pensja Całkowita`, `Pracownik_ID`) VALUES
(1, 'Maj', '11.11', 1),
(2, 'Maj', '11.11', 2),
(3, 'Maj', '11.11', 3),
(4, 'Maj', '11.11', 4),
...
--
-- Indeksy dla tabeli `kontoklient`
--
ALTER TABLE `kontoklient`
  ADD PRIMARY KEY (`ID`);

--
-- Indeksy dla tabeli `kontopracownik`
--
ALTER TABLE `kontopracownik`
  ADD PRIMARY KEY (`ID`);
...
--
ALTER TABLE `kredyt`
  ADD PRIMARY KEY (`ID`,`Klient_ID`,`DataZałożenia_ID`,`DataZakończenia_ID`,`Rodzaj Kredytu_ID`),
  ...
  ADD KEY `fk_Kredyt_Rodzaj Kredytu1_idx` (`Rodzaj Kredytu_ID`);
...
--
-- Indeksy dla tabeli `rachunekdebetowy`
--
ALTER TABLE `rachunekdebetowy`
  ADD PRIMARY KEY (`ID`,`Klient_ID`),
  ADD KEY `fk_RachunekDebetowy_Klient1_idx` (`Klient_ID`);

--
-- Indeksy dla tabeli `rachunekkredytowy`
--
ALTER TABLE `rachunekkredytowy`
  ADD PRIMARY KEY (`ID`,`Klient_ID`),
  ADD KEY `fk_RachunkeKredytowy_Klient1_idx` (`Klient_ID`);

--
-- Indeksy dla tabeli `rodzajkredytu`
--
ALTER TABLE `rodzajkredytu`
  ADD PRIMARY KEY (`ID`);

--
-- Indeksy dla tabeli `rodzajlokaty`
--
ALTER TABLE `rodzajlokaty`
  ADD PRIMARY KEY (`ID`);

--
-- Indeksy dla tabeli `rodzajtransakcji`
--
ALTER TABLE `rodzajtransakcji`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT dla tabeli `kontoklient`
--
ALTER TABLE `kontoklient`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT dla tabeli `kontopracownik`
--
ALTER TABLE `kontopracownik`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT dla tabeli `rodzajkredytu`
--
ALTER TABLE `rodzajkredytu`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT dla tabeli `rodzajlokaty`
--
ALTER TABLE `rodzajlokaty`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT dla tabeli `rodzajtransakcji`
--
ALTER TABLE `rodzajtransakcji`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Ograniczenia dla tabeli `daneosobowe`
--
ALTER TABLE `daneosobowe`
...
--
ALTER TABLE `klient`
  ADD CONSTRAINT `fk_Klient_DaneOsobowe` FOREIGN KEY (`DaneOsobowe_ID`) REFERENCES `daneosobowe` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Klient_KontoKlient1` FOREIGN KEY (`KontoKlient_ID`) REFERENCES `kontoklient` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `lokata`
  ...
  ADD CONSTRAINT `fk_Lokata_RodzajLokaty1` FOREIGN KEY (`RodzajLokaty_ID`) REFERENCES `rodzajlokaty` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Ograniczenia dla tabeli `pracownik`
--
ALTER TABLE `pracownik`
  ADD CONSTRAINT `fk_Pracownik_DaneOsobowe1` FOREIGN KEY (`DaneOsobowe_ID`) REFERENCES `daneosobowe` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Pracownik_KontoPracownik1` FOREIGN KEY (`KontoPracownik_ID`) REFERENCES `kontopracownik` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
-- Ograniczenia dla tabeli `rachunekdebetowy`
--
ALTER TABLE `rachunekdebetowy`
...
--
-- Ograniczenia dla tabeli `rachunekkredytowy`
--
ALTER TABLE `rachunekkredytowy`
...
ALTER TABLE `transakcje`
  ...
  ADD CONSTRAINT `fk_Transakcje_RodzajTransakcji1` FOREIGN KEY (`RodzajTransakcji_ID`) REFERENCES `rodzajtransakcji` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
